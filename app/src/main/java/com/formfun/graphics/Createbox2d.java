...
public class Createbox2d {
    ...
    void listenForCollisions(Context context) {
        Box2DContactListener contactlistener = new Box2DContactListener(context);
    ...
    Vec2 coordPixelsToWorld(Vec2 p) {
